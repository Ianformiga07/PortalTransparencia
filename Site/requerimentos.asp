    ...
    <div class="container">
      <nav class="breadcrumbs">
        <ol>
          ...
          <li class="current">Requerimentos</li>
        </ol>
      </nav>
      <h1>Requerimentos</h1>
    </div>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr>
              ...
              <td>16/08/2024</td>
              <td>
                <a href="#" class="btn-visualizar" data-toggle="modal" data-target="#requerimentos">
...
<!-- Modal for Denúncia -->
<div class="modal fade" id="requerimentos" tabindex="-1" role="dialog" aria-labelledby="requerimentosLabel" aria-hidden="true">
  <div class="modal-dialog custom-modal-dialog" role="document"> <!-- Classe personalizada adicionada aqui -->
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="requerimentosLabel">Requerimentos</h5>
      ...
      <div class="modal-body">
        <div class="document-card">
          ...
          <div class="document-details">
            <p><strong>Tipo de Documento:</strong> Requerimentos</p>
