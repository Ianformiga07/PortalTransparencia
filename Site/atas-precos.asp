    ...
    <div class="container">
      <nav class="breadcrumbs">
        <ol>
          ...
          <li class="current">Atas de Preços</li>
        </ol>
      </nav>
      <h1>Atas de Preços</h1>
    </div>
  </div><!-- End Page Title -->
...
<!-- Modal for Denúncia -->
<div class="modal fade" id="ata-preco" tabindex="-1" role="dialog" aria-labelledby="ata-precoLabel" aria-hidden="true">
  <div class="modal-dialog custom-modal-dialog" role="document"> <!-- Classe personalizada adicionada aqui -->
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ata-precoLabel">Atas de Sessões</h5>
      ...
      <div class="modal-body">
        <div class="document-card">
          ...
          <div class="document-details">
            <p><strong>Tipo de Documento:</strong> Atas de Preços</p>
