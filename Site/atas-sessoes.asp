    ...
    <div class="container">
      <nav class="breadcrumbs">
        <ol>
          ...
          <li class="current">Atas das Sessões</li>
        </ol>
      </nav>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr>
              ...
              <td>16/08/2024</td>
              <td>
                <a href="#" class="btn-visualizar" data-toggle="modal" data-target="#ataSessao">
...
<!-- Modal for Denúncia -->
<div class="modal fade" id="ataSessao" tabindex="-1" role="dialog" aria-labelledby="ataSessaoLabel" aria-hidden="true">
  <div class="modal-dialog custom-modal-dialog" role="document"> <!-- Classe personalizada adicionada aqui -->
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ataSessaoLabel">Atas de Sessões</h5>
