    ...
    <div class="container">
      <nav class="breadcrumbs">
        <ol>
          ...
          <li class="current">PCA - Plano de Contratação Anual</li>
        </ol>
      </nav>
      <h1>PCA - Plano de Contratação Anual</h1>
    <!-- Ícone de Voltar -->
  ...
  <div class="modal-dialog custom-modal-dialog" role="document"> <!-- Classe personalizada adicionada aqui -->
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="oficioLabel">PCA - Plano de Contratação Anual</h5>
      ...
      <div class="modal-body">
        <div class="document-card">
          ...
          <div class="document-details">
            <p><strong>Tipo de Documento:</strong> PCA</p>
