  ...
  <section class="content-header bg-white p-bottom-5">
      <h1 class="font-w-300">
          <i class="fa fa-edit text-blue"></i> Execução Orçamentária
      </h1>
      <ol class="breadcrumb font-s-1">
          <li><a href="dashboard.php?control=home/all"><i class="fa fa-dashboard"></i> Painel</a></li> / 
          <span class="font-w-600">Execução Orçamentária</span>
      </ol>
  </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
              <div class="box-footer">
                <a href="cad-execOrcamentaria.asp" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Novo Documento</a>
              </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <tr>
                  <td>PCA - Plano de Contratação Anual</td>
                  <td>0254</td>
                  <td>Ata da 09ª Sessão Ordinária da Câmara Municipal de Ananás, Estado do Tocantins.</td>
                  <td>14/07/2024</td>
                  <td>Ativo</td>
                  <td>
